...
class BookMyShow {
    ...
    private void createBooking(City userCity, String movieName) {
        ...
        //3. get all show of this movie in this location
...
class MovieController {
    ...
    MovieController(){ cityVsMovies = new HashMap<>(); allMovies = new ArrayList<>(); }
    ...
    Movie getMovieByName(String movieName) {
        for(Movie movie : allMovies) {
            if((movie.getMovieName()).equals(movieName)) return movie;
        }
        return null;
    }
    List<Movie> getMoviesByCity(City city) { return cityVsMovies.get(city); }
}
...
class TheatreController {
    ...
    TheatreController() { cityVsTheatre = new HashMap<>(); allTheatre = new ArrayList<>(); }
